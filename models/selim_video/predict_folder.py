...
if __name__ == '__main__':
    ...
    arg('--weights-dir', type=str, default="models/selim_video/weights", help="path to directory with checkpoints")
    ...
    #print(predictions)
    with open("models/selim_video/result.txt", "w") as text_file:
